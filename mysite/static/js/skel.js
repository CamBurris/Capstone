    ...
    var a = {
        ...
        changeState: function (b) {
            ...
            if (a.cache.states[a.stateId]) c = a.cache.states[a.stateId];
                ...
                10 <= a.vars.IEVersion && (g = "mVIE" + a.stateId, (f = a.getCachedElement(g)) || (f = a.cacheElement(g, a.newInline("@-ms-viewport{width:" + ("wp" == a.vars.deviceType ? 0.6666666666666667 * a.vars.viewportWidth + "px" : "device-width") +
                    "}"), "head", 2)), c.elements.push(f));
            ...
            (function () {
                var b = window,
                    d = function (a) {
                        ...
                        a = !1;
                        if (!e)
                            if (e = !0, "loading" !== c.readyState && h(), c.addEventListener) c.addEventListener("DOMContentLoaded",
                                g, !1), b.addEventListener("load", g, !1);
                            else if (c.attachEvent) {
                            c.attachEvent("onreadystatechange", g);
                            b.attachEvent("onload", g);
                            try {
                                a = null == b.frameElement
                            } catch (m) {}
                            c.documentElement.doScroll && a && k()
                        }
                    }, c = b.document,
                    e = !1,
                    f = [],
                    g = function () {
                        c.addEventListener ? c.removeEventListener("DOMContentLoaded", g, !1) : c.detachEvent("onreadystatechange", g);
                        h()
                    }, h = function () {
                        if (!d.isReady) {
                            if (!c.body) return setTimeout(h, 1);
                            d.isReady = !0;
                            a.iterate(f, function (a) {
                                f[a]()
                            });
                            f = []
                        }
        ...
        initAPI: function () {
            ...
            a.vars.IEVersion = c.match(/MSIE ([0-9]+)\./) ? RegExp.$1 : 99;
